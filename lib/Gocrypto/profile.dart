...
import 'package:untitled5/Gocrypto/FAQ.dart';
import 'package:untitled5/Gocrypto/my_account.dart';
import 'package:untitled5/Gocrypto/payment_method.dart';
import 'package:untitled5/Gocrypto/select_language.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => BitQix()));
                  },
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: Colors.white,
